    ...
    <main className="mx-auto w-full max-w-7xl space-y-8 px-4 py-10 lg:px-10">
      <header className="space-y-3 border-b border-zinc-300 pb-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/admin/operations/delivery-failures" className="inline-flex h-10 items-center border border-zinc-300 px-4 text-xs font-semibold uppercase tracking-[0.12em]">
            Delivery Failures
          </Link>
          <Link href="/admin/operations/return-damage-disputes" className="inline-flex h-10 items-center border border-zinc-300 px-4 text-xs font-semibold uppercase tracking-[0.12em]">
            Damage Disputes
          </Link>
          <Link href="/admin/operations/cod-abuse" className="inline-flex h-10 items-center border border-zinc-300 px-4 text-xs font-semibold uppercase tracking-[0.12em]">
            COD Abuse
          </Link>
        </div>
      </header>

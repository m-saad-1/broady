...
export const productBaseSchema = z.object({
  ...
  gender: z.enum(["Men", "Women", "Juniors", "men", "women", "boys", "girls"]),
  ...
  division: optionalTextSchema,
  category: optionalTextSchema,
  subType: optionalTextSchema,
  subTypeConfidence: z.enum(["explicit", "inferred", "null"]).optional(),
  mappingStatus: z.enum(["complete", "partial", "unresolved"]).optional(),
  resolutionSource: z.enum(["url_and_breadcrumb", "url_only", "breadcrumb_only", "adapter_label", "title_keyword", "admin_manual", "unresolved"]).optional(),
